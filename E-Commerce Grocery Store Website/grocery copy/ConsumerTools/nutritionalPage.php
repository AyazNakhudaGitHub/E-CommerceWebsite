...
<html>
    ...
    <body>
        ...
        <br>
        <form method = "POST">
            <div id="form"> <!--This form will take in a user's food item-->
                ...
                <br>
                <p id="printHere"></p> <!--The nutrional facts for the searched food item will appear here-->
            </div>
        </form>
            <script type="text/javascript">
                $(document).ready(function(){
                    ...
                    $('#button').click(function(){
                        var x = document.getElementById("text").value;//get the text in the text box
                        const settings = {
                            "async": true,
                            "crossDomain": true,
                            "url": "https://edamam-food-and-grocery-database.p.rapidapi.com/parser?ingr="+x, // here I attach the searched food item to the url which will be sent to the API 
                            "method": "GET",
                            "headers": {
                        ...
                        $.ajax(settings).done(function (response) {                            
                            // The if statements below search for speciifc nutrients
                            // Due to how the API's JSON response body is structured, 
                            // there needs to be quite a lot of if statements
                            var displayString = "";
