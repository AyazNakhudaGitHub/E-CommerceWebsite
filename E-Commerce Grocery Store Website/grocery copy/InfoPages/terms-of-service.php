...
<head>
    ...
    <!-- Additional formatting that allows for Bootstrap compatibility -->
    <style>
...
<body>
    <!-- Header: -->
    <?php require_once("../ShoppingCart/components/header.php"); ?>

    <!-- Main tag is used to show all page content -->
    <main style="background-color: #2d4154;">
        <!-- This is a container for the "Terms of Service" banner and text -->
        <div class="wide-container tos">
            <!-- This class displays the "Terms of Service" title centered on the banner image -->
            <span class="text-on-img-centered">&nbsp;Terms of Service&nbsp;</span>
            <!-- This class displays the image source on the bottom left of the banner image -->
            <span class="text-on-img-bottomleft">Source: https://www.pexels.com/</span>
        </div>

        <!-- A wrapper for all the text content -->
        <div class="content-wrapper">
            <br><br><br>
            <!-- The terms of service -->
            <p class="content-wrapper tos-text">
                <b>OVERVIEW</b><br><br>
This website is operated by TheGroceryStore. Throughout the site, the terms “we”, “us” and “our” refer to TheGroceryStore. TheGroceryStore offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here. 
...
In no case shall TheGroceryStore, our directors, officers, employees, affiliates, agents, contractors, interns, suppliers, service providers or licensors be liable for any injury, loss, claim, or any direct, indirect, incidental, punitive, special, or consequential damages of any kind, including, without limitation lost profits, lost revenue, lost savings, loss of data, replacement costs, or any similar damages, whether based in contract, tort (including negligence), strict liability or otherwise, arising from your use of any of the service or any products procured using the service, or for any other claim related in any way to your use of the service or any product, including, but not limited to, any errors or omissions in any content, or any loss or damage of any kind incurred as a result of the use of the service or any content (or product) posted, transmitted, or otherwise made available via the service, even if advised of their possibility. Because some states or jurisdictions do not allow the exclusion or the limitation of liability for consequential or incidental damages, in such states or jurisdictions, our liability shall be limited to the maximum extent permitted by law. 
<br><br>
<b>SECTION 14 - INDEMNIFICATION </b><br>
You agree to indemnify, defend and hold harmless TheGroceryStore and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys’ fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party. 
<br><br>
...
Questions about the Terms of Service should be sent to us at info@TheGroceryStore.com
<br>
            </p>
            <br>            
        </div>
